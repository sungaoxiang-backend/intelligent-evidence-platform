...
class EvidenceFeaturesExtractor:
    ...
    def build_instructions(self):
        ...
        5. 确保number类型的值在小数点后的值时输出的0的意义，如1000.00，则输出1000，而不是1000.00；如1000.50，则输出1000.5，而不是1000.50；如1000.35，则输出1000.35，而不是1000.350
        </Quality Guidelines>
        ...
        6. 在提取到number值时，要考虑如果是小数，则要考虑小数点位置，确保小数点后的0的输出具有意义。如1000.00，则输出时需要是1000，而不是1000.00；如1000.50，则输出时需要是1000.5，而不是1000.50；如1000.35，则输出时需要是1000.35，而不是1000.350
        </Output Format>
        """
