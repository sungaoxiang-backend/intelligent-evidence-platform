...
一、请求判令两被告偿还原告借款本金{{case_amount}}元及逾期利息（自起诉之日起，按全国银行间同业拆借中心公布的一年期贷款市场报价利率计算至借款实际清偿完毕之日止）。

二、请求判令本案诉讼费由被告承担。

### 事实与理由

原被告系朋友关系，原告{{creditor_name}}陆续出借被告{{debtor_name}}借款{{case_amount}}元，截至起诉之日，被告余欠原告借款{{case_amount}}元。原告多次催讨未果，故双方纠纷成讼。
